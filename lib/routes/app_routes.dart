...
import 'package:store_app/view/pages/address/address_page.dart';
...
import 'package:store_app/view/pages/track_order_page/track_order_page.dart';
...
class AppRoute {
  ...
  static String getItemDetail(String pageId, String page) =>'$itemDetail?pageId=$pageId&page=$page';
  ...
  static String getCategoryItems(String catId) => '$categoryItems?catId=$catId';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
      name: categoryItems,
      page: () => CategoryItemsPage(catId: Get.parameters['catId']!),
      transition: Transition.fadeIn),
    ...
    GetPage(
      ...
      page: () {
        ...
        return ItemDetail(pageId: pageId!, page: page!);
      },
      transition: Transition.fadeIn),
  ];
}
